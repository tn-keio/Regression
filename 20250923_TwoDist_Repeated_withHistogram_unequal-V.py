...
def plot_initial_data(x_total, y_total, dist_name):
    ...
    plt.title(f'Scatter Plot of Full Dataset ({dist_name}, Variance-Aware Outliers)\nKendall\'s τ = {tau_full:.4f}', fontsize=16)
...
def run_simulation_and_plot(x_total, y_total, dist_name):
    ...
    for method, lines in results.items():
        ...
        title_text = f'{plot_titles[method]} on {dist_name} Data (100 Trials, Heteroscedastic)\n'
